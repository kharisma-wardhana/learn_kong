package com.learn.merchant.datasource.mysql.config;
...
@EnableJpaRepositories(
        basePackages = "com.learn.merchant.datasource.mysql.repo",
...
public class MysqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterManagerFactory(EntityManagerFactoryBuilder builder) {
        LocalContainerEntityManagerFactoryBean entityManagerFactory = builder
                ...
                .packages("com.learn.merchant.datasource.mysql.entity")
                .build();
